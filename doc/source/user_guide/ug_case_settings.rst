...
.. csv-table:: *Namelist Inputs*
   ...
   "``flux_convergence_tolerance``", "real", "set a tolerance for convergence of ustar", "0.0d0"
   "``use_coldair_outbreak_mod``", "true/false", "Use Mahrt and Sun 1995 cold air outbreaks", "``.false.``"
   "``alpha_coa``", "real", "cold air outbreak parameter", "1.4d0"
   "``maxscl_coa``", "real", "cold air outbreak parameter", "2.0d0"
   "``td0_coa``", "real", "cold air outbreak parameter", "=10.0d0"
