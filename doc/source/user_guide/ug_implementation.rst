...
.. csv-table:: *Biogeochemical History variables*
   ...
   "f\_fiso\_atm", "atmospheric isosol deposition flux", "fiso\_atm", "kg m\ :math:`^{-2}` s\ :math:`^{-1}`"
   "f\_fiso\_ocn", "isosol flux from ice to ocean", "fiso\_ocn", "kg m\ :math:`^{-2}` s\ :math:`^{-1}`"
   "f\_iso", "isotope mass (snow and ice)", "aerosno, aeroice", "kg/kg"
