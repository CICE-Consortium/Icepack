...
.. csv-table:: Table 8
   ...
   "``tr_zero``", "true/false", "turns on black carbon and dust aerosols", ""
   ...
   "``dEdd_algae``", "true/false", "Include radiative impact of algae and aerosols in the delta-Eddington shortwave scheme. Requires shortwave = 'dEdd'. Should not be used when solve_zbgc or skl_bgc are true)", ""
   ...
   "``solve_zsal``", "true/false", "prognostic salinity tracer used with therm = 1", ""
   ...
   "``frazil_scav``", "real", "for each bgc tracer, specifies the fraction or multiple of the ocean concentration that is retained in the ice from frail formation", "0.8"
   ...
   "``ratio_Fe2C_diatoms``", "real", "algal Fe to C (umol/mol) for diatoms", "0.0033"
   "``ratio_Fe2C_sp``", "real", "algal Fe to C (umol/mol) for small phytoplankton", "0.0033"
   "``ratio_Fe2C_phaeo``", "real", "algal Fe to C (umol/mol) for phaeocystis", "0.1"
   "``ratio_Fe2N_diatoms``", "real", "algal Fe to N (umol/mol) for diatoms", "0.023"
   "``ratio_Fe2N_sp``", "real", "algal Fe to N (umol/mol) for small phytoplankton", "0.023"
   "``ratio_Fe2N_phaeo``", "real", "algal Fe to N (umol/mol) for phaeocystis", "0.7"
   "``ratio_Fe2DON``", "real", "Fe to N of DON (nmol/umol)", "0.023"
   "``ratio_Fe2DOC_s``", "real", "Fe to C of DOC for saccharids (nmol/umol)", "0.1"
   "``ratio_Fe2DOC_l``", "real", "Fe to C of DOC for lipids (nmol/umol)", "0.033"
   ...
   "``algal_vel``", "real", "0.5 cm/d(m/s)", "1.11e-8"
   ...
   "``alpha2max_low_diatoms``", "real", "diatoms light limitation (1/(W/m^2))", "0.8"    
   "``alpha2max_low_sp``", "real", "small phytoplankton light limitation (1/(W/m^2))", "0.67"    
   "``alpha2max_low_phaeo``", "real", "phaeocystis light limitation (1/(W/m^2))", "0.67"    
   "``beta2max_diatoms``", "real", "diatoms light inhibition (1/(W/m^2))", "0.018"    
   "``beta2max_sp``", "real", "small phytoplankton light inhibition (1/(W/m^2))", "0.0025"    
   "``beta2max_phaeo``", "real", "phaeocystis light inhibition (1/(W/m^2))", "0.01" 
   "``mu_max_diatoms``", "real", "diatoms maximum growth rate (1/day)", "1.2" 
   "``mu_max_sp``", "real", "small phytoplankton maximum growth rate (1/day)", "0.851"  
   "``mu_max_phaeo``", "real", "phaeocystis maximum growth rate (1/day)", "0.851" 
   "``grow_Tdep_diatoms``", "real", "diatoms Temperature dependence of growth (1/C)", "0.06" 
   "``grow_Tdep_sp``", "real", "small phytoplankton Temperature dependence of growth (1/C)", "0.06"  
   "``grow_Tdep_phaeo``", "real", "phaeocystis Temperature dependence of growth (1/C)", "0.06"  
   ...
   "``mort_pre_diatoms``", "real", "diatoms mortality (1/day)", "0.007" 
   "``mort_pre_sp``", "real", "small phytoplankton mortality (1/day)", "0.007"  
   "``mort_pre_phaeo``", "real", "phaeocystis mortality (1/day)", "0.007" 
   "``mort_Tdep_diatoms``", "real", "diatoms temperature dependence of mortality (1/C)", "0.03" 
   "``mort_Tdep_sp``", "real", "small phytoplankton temperature dependence of mortality (1/C)", "0.03"  
   "``mort_Tdep_phaeo``", "real", "phaeocystis temperature dependence of mortality (1/C)", "0.03" 
   "``k_exude_diatoms``", "real", "diatoms algal exudation (1/d)", "0.0" 
   "``k_exude_sp``", "real", "small phytoplankton algal exudation (1/d)", "0.0"  
   "``k_exude_phaeo``", "real", "phaeocystis algal exudation (1/d)", "0.0"           
   "``K_Nit_diatoms``", "real", "nitrate half saturation (mmol/m^3)", "1.0" 
   "``K_Nit_sp``", "real", "nitrate half saturation (mmol/m^3)", "1.0"  
   "``K_Nit_phaeo``", "real", "nitrate half saturation (mmol/m^3)", "1.0"           
   "``K_Am_diatoms``", "real", "ammonium half saturation (mmol/m^3)", "0.3" 
   "``K_Am_sp``", "real", "ammonium half saturation (mmol/m^3)", "0.3"  
   "``K_Am_phaeo``", "real", "ammonium half saturation (mmol/m^3)", "0.3"   
   "``K_Sil_diatoms``", "real", "silicate half saturation (mmol/m^3)", "4.0" 
   "``K_Sil_sp``", "real", "silicate half saturation (mmol/m^3)", "0.0"  
   "``K_Sil_phaeo``", "real", "silicate half saturation (mmol/m^3)", "0.0" 
   "``K_Fe_diatoms``", "real", "iron half saturation (nM)", "1.0" 
   "``K_Fe_sp``", "real", "iron half saturation (nM)", "0.2"  
   "``K_Fe_phaeo``", "real", "iron half saturation (nM)", "0.1"   
   "``f_don_protein``", "real", "fraction of spilled grazing to proteins", "0.6" 
   "``kn_bac_protein``", "real", "Bacterial degredation of DON (1/d)", "0.03"                
   "``f_don_Am_protein``", "real", "fraction of remineralized DON to ammonium", "0.25"
   "``f_doc_s``", "real", "saccharids fraction of mortality to DOC", "0.4"
   "``f_doc_l``", "real", "lipids fraction of mortality to DOC", "0.4"  
   "``f_exude_s``", "real", "saccharids fraction of exudation to DOC", "1.0"
   "``f_exude_l``", "real", "lipids fraction of exudation to DOC", "1.0"  
   "``k_bac_s``", "real", "saccharids bacterial degredation of DOC (1/d)", "0.03"
   "``k_bac_l``", "real", "lipids bacterial degredation of DOC (1/d)", "0.03"  
   "``T_max``", "real", "maximum temperature (C)", "0.0"
   ...
   "``k_nitrif``", "real", "nitrification rate (1/day)", "0.0"
   "``t_iron_conv``", "real", "desorption loss pFe to dFe (day)", "3065.0"
   "``max_loss``", "real", "restrict uptake to % of remaining value", "0.9"
   "``max_dfe_doc1``", "real", "max ratio of dFe to saccharides in the ice (nM Fe/muM C)", "0.2"
   "``fr_resp_s``", "real", "DMSPd fraction of respiration loss as DMSPd", "0.75"
   "``y_sk_DMS``", "real", "fraction conversion given high yield", "0.5"
   "``t_sk_conv``", "real", "Stefels conversion time (d)", "3.0"
   "``t_sk_ox``", "real", "DMS oxidation time (d)", "10.0"
   "``algaltype_diatoms``", "real", "mobility type between stationary <--> mobile", "0.0"
   "``algaltype_sp``", "real", "mobility type between stationary <--> mobile", "0.5"
   "``algaltype_phaeo``", "real", "mobility type between stationary <--> mobile", "0.5"
   "``nitratetype``", "real", "mobility type between stationary <--> mobile", "-1.0"
   "``ammoniumtype``", "real", "mobility type between stationary <--> mobile", "1.0"
   "``silicatetype``", "real", "mobility type between stationary <--> mobile", "-1.0"
   "``dmspptype``", "real", "mobility type between stationary <--> mobile", "0.5"
   "``dmspdtype``", "real", "mobility type between stationary <--> mobile", "-1.0"
   "``humtype``", "real", "mobility type between stationary <--> mobile", "1.0"
   "``doctype_s``", "real", "mobility type between stationary <--> mobile", "0.5"
   "``doctype_l``", "real", "mobility type between stationary <--> mobile", "0.5"
   "``dontype_protein``", "real", "mobility type between stationary <--> mobile", "0.5"
   "``fedtype_1``", "real", "mobility type between stationary <--> mobile", "0.5"
   "``feptype_1``", "real", "mobility type between stationary <--> mobile", "0.5"
   "``zaerotype_bc1``", "real","mobility type between stationary <--> mobile",  "1.0"
   "``zaerotype_bc2``", "real", "mobility type between stationary <--> mobile", "1.0"
   "``zaerotype_dust1``", "real", "mobility type between stationary <--> mobile", "1.0"
   "``zaerotype_dust2``", "real", "mobility type between stationary <--> mobile", "1.0"
   "``zaerotype_dust3``", "real", "mobility type between stationary <--> mobile", "1.0"
   "``zaerotype_dust4``", "real", "mobility type between stationary <--> mobile", "1.0"
