...
! author Elizabeth C. Hunke, LANL
      ...
      use icedrv_domain_size, only: nilyr, nslyr, nblyr, max_ntrcr, ncat, n_aero, n_iso, nfsd
      ...
      logical (kind=log_kind) :: tr_iage, tr_FY, tr_lvl, tr_pond, tr_aero, tr_iso, tr_fsd
