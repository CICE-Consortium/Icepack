...
CICE Consortium Icepack sea ice model.
...
tests are run from the command line like
  ...
  > icepack.create.case -t smoke -m wolf -g gx3 -p 8x2 -s diag1,run5day -testid myid
...
icepack.create.case with -t or -ts require a testid to uniquely name test directories.  The format
...
-td allows a user to compare one test result to another.  For instance,
  > icepack.create.case -t smoke -m wolf -g gx3 -p 8x2 -s run5day -testid t01
  > icepack.create.case -t smoke -m wolf -g gx3 -p 4x2 -s run5day -testid t01 -td smoke_gx3_8x2_run5day
...
- The '-testid' flag allows users to specify a testing id that will be added to the
    end of the case directory.  For example, "./icepack.create.case -m wolf -t smoke -testid t12 -p 4x1"
