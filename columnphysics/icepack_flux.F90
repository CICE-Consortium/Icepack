...
! author: Elizabeth C. Hunke and William H. Lipscomb, LANL
      ...
      real (kind=dbl_kind), optional, intent(in) :: &
          ...
          fswthrun_uvrdr, & !   > 700nm uv  dir sw radiation through ice bot (W/m**2)
          fswthrun_uvrdf, & !   > 700nm uv  dif sw radiation through ice bot (W/m**2)
      ...
      real (kind=dbl_kind), optional, intent(inout) :: &
          ...
          fswthru_uvrdr, & !   > 700nm uv  dir sw radiation through ice bot (W/m**2)
          fswthru_uvrdf, & !   > 700nm uv  dif sw radiation through ice bot (W/m**2)
