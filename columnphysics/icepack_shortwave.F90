...
!autodocument_end
      ...
      !-----------------------------------------------------------------
               ...
               fswthrunvdr(n) = scale_factor*fswthrunvdr(n)
               fswthrunvdf(n) = scale_factor*fswthrunvdf(n)
               fswthrunidr(n) = scale_factor*fswthrunidr(n)
               fswthrunidf(n) = scale_factor*fswthrunidf(n)
               do k = 1,nilyr+1
